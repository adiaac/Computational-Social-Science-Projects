...
assignment <- sample(c(0, 1), num_units, replace = TRUE)
...
visualize_df<-data.frame(assignment, ypsps$college)
ggplot(df, aes(x = baseline_covariate, fill = assignment)) +
  geom_bar(position = "dodge", width = 0.5) +
  labs(x = "Baseline Covariate", y = "Count", fill = "Assignment") +
  ggtitle("Distribution of Covariate by Treatment/Control Condition")
